package com.nicholas.smartwallet.util;
...
public class NFCUtil {
	...
	public static NdefMessage createNdefMsg(String[] mContent){
		NdefMessage ndefMsg = NFCUtil.getStringArrayAsNdef(
				NdefRecord.TNF_MIME_MEDIA, "state/data", "", mContent,
				DELIMETER);
		return ndefMsg;
	}
	

	public static NdefMessage getStringArrayAsNdef(short tnf, String type,
			String id, String[] payload, String delimiter) {
	...
	// With AAR
	public static NdefMessage createNdefMsg(String[] mContent, NdefRecord AAR){
		NdefMessage ndefMsg = NFCUtil.getStringArrayAsNdef(
				NdefRecord.TNF_MIME_MEDIA, "state/data", "", mContent,
				DELIMETER,AAR);
	...
	public static NdefMessage getStringArrayAsNdef(short tnf, String type,
			String id, String[] payload, String delimiter, NdefRecord AAR) {
		byte[] idBytes = id.getBytes();
